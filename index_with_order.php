...
<div class="wrappage">
  ...
  <div class="container">
	...
	Get your buzz T-shirts. Stocks are going to be limited, so hurry! <br />
        If you need multiple T-shirts, fill this form multiple times.<br />
        ...
        <div class="block-12 left">
          ...
          <!--ul class="info last">
            <li class="skills left">
              <span>
                Photoshop
              </span>
              / 5 years experience
            </li>
            <li class="skills right progress">
              <span class="p-100">
              </span>
            </li>
            <li class="skills left">
            ...
            <li class="skills right progress last">
              <span class="p-50">
              </span>
            </li>
            <li class="skills left last">
          ...
          <div id="style-form">
            <form id="shirt" name="shirt" method="post" action="shirthandler.php">
              ...
              <!--div class="wrapper-block left">
                ...
                <textarea id="message" rows="3" cols="10" title="Your Message" class="req-string"></textarea>
              </div-->
	      <div class="wrapper-block left">
	        <label for="size">
		  Size
	 	</label>
		<select name="size" id="size" title="size" class="req-string select-box">
		  <option value="small">Small</option>
		  <option value="medium">Medium</option>
		  <option value="large">Large</option>
		  <option value="extra">XL</option>
		  <option value="huge">XXL</option>
		</select>
	      </div>
	      <div class="wrapper-block left">
	        <label for="number">
		...
		<select name="number" id="number" title="number" class="req-string select-box">
	...
	<p>
        ...
        <div class="block-12 left">
          <div id="style-form">
            <form id="form" name="form" method="post" action="postsubmit.php">
              <div class="wrapper-block left">
                <label for="name">
                  Name
                  <span class="small-label">
